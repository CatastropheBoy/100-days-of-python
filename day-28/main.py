...
def reset_timer():
    ...
    header_label.config(text="Pomodoro")
...
def count_down(count):
    ...
    if count > 0:
        ...
        for _ in range(0, math.floor(reps // 2)):
            checks += "✔"
        cycle_count.config(text=checks)
...
header_label = Label(text="Pomodoro", fg=GREEN, bg=YELLOW, font=(FONT_NAME, 35, "bold"))
...
cycle_count = Label(fg=GREEN, bg=YELLOW, font=(FONT_NAME, 20, "normal"))
