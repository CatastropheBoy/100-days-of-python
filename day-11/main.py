...
def start_game():
    ...
    print(
        f"The dealer shows: {dealer_hand}\nDealer total is: {calculate_score(dealer_hand)}")
    print(
        f"Your hand: {player_hand}\nYour total is: {calculate_score(player_hand)}")
    game_over = False
    bust = False    
    while not game_over:
    ...
    if bust:
        ...
        while calculate_score(dealer_hand) < 17:
            dealer_hand.append(deal())
        print(f"The dealer shows: {dealer_hand}\nDealer total is: {calculate_score(dealer_hand)}")
        if calculate_score(dealer_hand) == 21:
            ...
            print("Dealer has the highest hand, you lose")
        else:
            print("You have the highest hand, you win.")
